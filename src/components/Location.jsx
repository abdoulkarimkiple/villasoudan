  ...
  return (
    <section id="contact" className="section-pad bg-sand">
      <div className="mx-auto grid max-w-7xl gap-8 px-5 md:px-8 lg:grid-cols-[0.86fr_1.14fr] lg:items-stretch">
        <div className="bg-ivory p-7 shadow-soft md:p-10">
        ...
        <div className="relative min-h-[360px] overflow-hidden bg-ink">
          <div className="absolute inset-0 opacity-75 [background-image:linear-gradient(rgba(244,238,225,0.12)_1px,transparent_1px),linear-gradient(90deg,rgba(244,238,225,0.12)_1px,transparent_1px)] [background-size:42px_42px]" />
          ...
          <div className="absolute bottom-6 left-6 right-6 bg-ivory p-5 shadow-soft">
